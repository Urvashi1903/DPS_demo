...
const FlipCard = () => {
    return (
        <div className='inter-font h-screen p-5 bg-[#1a1a1a] text-white grid grid-rows-1 grid-cols-1 overflow-x-hidden'>
            <div className='bg-[#363535] grid grid-rows-2 grid-cols-1'>

                {/* header */}
                <div className='grid grid-cols-1 md:grid-cols-2 grid-rows-3'>
                    {/* row1 - name */}
                    <div className='uppercase text-[12px] md:text-[14px] lg:text-[12px] p-[12px] leading-3.5 lg:leading-3 font-medium'>
                        <p>studio productive</p>
                        <p>modern design</p>
                    </div>
                    {/* row1 - tags */}
                    <div className='uppercase p-[12px] font-medium'>
                        <div className='flex flex-wrap lg:flex-nowrap justify-end items-start gap-0 text-[12px] md:text-[15px]'>
                    ...
                    {/* row2 - name */}
                    <div className='uppercase p-[12px] leading-10 text-[35px] md:text-[50px] xl:text-[60px] font-medium'>
                        <div className='flex md:block lg:flex'>
                            <p className='mr-[12px]'>Magic</p>
                            <p className='mr-[9px]'>layout</p>
                        </div>
                    </div>
                    <div className='p-[12px] text-[12px] md:text-[14px] lg:text-[17px] xl:text-[20px] md:border-t lg:border-t-2 border-white flex items-end font-medium'>
                        <p>Discover modern methods <u>creating websites</u>  based on the magic grid and minimalist layout with cards.</p>
                    </div>
                    {/* row3 -  */}
                    <div></div>
                    <div className='hidden lg:flex p-[12px] uppercase items-end justify-between'>
                ...
                {/* cards */}
                <div className='min-h-[650px] bg-[#363535]'>

                    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
                        {/* 1st */}
                        <div className='p-[12px] perspective flex-[1_1_300px] max-w-[100%]'>
                            {/* inner */}
                            <div className='w-full h-[520px] relative origin-center transform-3d hover:rotate-y-180 duration-500 delay-150'>
                                {/* front */}
