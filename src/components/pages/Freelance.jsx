...
const Freelance = () => {
  return (
    <div className='lg:h-screen bg-[#e685aa] text-white py-[30px] lg:py-[100px] px-[40px] lg:px-[100px] xl:px-[250px] w-full flex flex-col items-center justify-center lg:flex-row gap-10 overflow-hidden'>
      {/* left-content */}
      <div className='flex flex-col lg:items-start lg:w-[50%]'>
        ...
        <div className='flex gap-6 items-center justify-center mb-[25px]'>
          ...
          <p className='capitalize text-[18px] font-bold'>celia almeda</p>
        </div>
        <div className='flex flex-col items-center justify-center lg:items-start gap-5 text-center lg:text-justify'>
          ...
          <p className='text-[17px] font-light mb-[20px]'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Soluta aliquam iure maiores quia id quidem reiciendis iste dolore laborum corporis, error consequuntur tempora asperiores, molestias placeat! Nostrum repudiandae iure porro!</p>
          <p className='text-[15px] font-light mb-[20px]'>Lorem ipsum dolor sit amet.</p>
      ...
      {/* right-swiper */}
      <div className='shadow-2xl shadow-black w-[80vw] lg:w-[50%] lg:h-full h-[80vw]'>
        <Swiper
          loop={true}
          pagination={true}
          navigation={true}
