...
const Contact = () => {
    return (
        <div className='mt-[50px] lg:mt-[100px] overflow-x-hidden w-full'>
            {/* header-content */}
            <div className='mx-[25px] lg:mx-[100px] xl:mx-[200px] flex flex-col md:flex-row justify-center gap-10'>
                ...
                <section className='lg:w-[50%]'>
                    <div className='leading-6 md:leading-9'>
                        <h2 className='uppercase text-[#194877] font-bold tracking-widest pb-3 md:pb-0'>contact me</h2>
                    ...
                    <div className='mt-7'>
                        {/* 1-box */}
                        <div className='border border-gray-300 lg:max-w-[50%] p-2 mb-7 flex items-center justify-center gap-2 '>
                ...
                {/* right */}
                <section className='bg-gray-200 md:w-[50%] p-5 lg:p-7 shadow-xl'>
                    <form>
                        <div className='mb-4'>
                        ...
                        <button className='cursor-pointer bg-[#143557] text-white font-bold w-full p-2'>Submit</button>
                    </form>
                </section>
            </div>
            {/* footer-content */}
            <div className='mt-20 h-full'>
                <section className='bg-[#14355723] py-7 md:py-15 px-10 lg:px-30 flex flex-col lg:flex-row gap-5 items-center justify-between'>
                    ...
                    <div>
                        <form>
                            <input type='text' placeholder='Email' className='font-[500] mr-5 p-2 bg-white outline-none border border-gray-300'></input>
                            <button className='cursor-pointer bg-green-900 text-white p-2 mt-5 lg:mt-0'>Subscribe</button>
                        </form>
                    </div>
                </section>
            </div>
            ...
            <div className='w-full h-[400px] relative'>
                ...
                {/* overlay-container */}
                    <div className='cursor-pointer bg-white absolute top-1/4 right-5 lg:right-[150px] p-7 hidden md:block md:w-[40%] lg:w-[25%] shadow-2xl'>
